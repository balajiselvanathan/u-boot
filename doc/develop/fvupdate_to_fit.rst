...
.. list-table::
   ...
   * - ``xml_file``
     ...
     - Required
   * - ``--guid``
     - GUID value of the board (enables complete mode). Board-specific GUIDs: qcs6490-rb3gen2: ``6f25bfd2-a165-468b-980f-ac51a0a45c52``, lemans-evk: ``78462415-6133-431c-9fae-48f2bafd5c71``
     - Required
   * - ``--mkeficapsule``
...
This example demonstrates the expected XML structure with UPDATE operations for
